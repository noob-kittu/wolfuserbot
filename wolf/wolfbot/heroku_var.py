...
class config(object):
    ...
    WOLF_NAME = os.environ.get("WOLF_NAME", None)
    ...
    UPSTREAM_REPO_URL = os.environ.get("UPSTREAM_REPO_URL","https://github.com/MrSammyXD/wolfuserbot")
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "wolfs")
    CONSOLE_LOGGER_VERBOSE = sb(os.environ.get("CONSOLE_LOGGER_VERBOSE", "False"))
