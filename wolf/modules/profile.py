...
@mrsammy(outgoing=True, pattern="^!reserved$")
...
@mrsammy(outgoing=True, pattern="^!name")
...
@mrsammy(outgoing=True, pattern="^!setpfp$")
...
@mrsammy(outgoing=True, pattern="^!setbio (.*)")
...
@mrsammy(outgoing=True, pattern="^!username (.*)")
...
@mrsammy(outgoing=True, pattern="^!count$")
...
@mrsammy(outgoing=True, pattern=r"^!delpfp")
