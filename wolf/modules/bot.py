...
from wolf.events import mrsammy, itzjass, progress, humanbytes, time_formatter
from wolf import CMD_HELP, ALIVE_NAME, PM_MESSAGE, WOLF_NAME, WOLF_MSG, ORI_MSG, bot as wolfs
...
from wolf import (TEMP_DOWNLOAD_DIRECTORY, CMD_HELP, bot)
...
@wolfs.on(itzjass(pattern=f"info(?: |$)(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern="^!info(?: |$)(.*)")
async def _(event):
  sender = await event.get_sender() ; me = await event.client.get_me()
  if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
...
@wolfs.on(itzjass(pattern=f"lyrics2(?: |$)(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern="^!lyrics2(?: |$)(.*)")
async def _(event):
  sender = await event.get_sender() ; me = await event.client.get_me()
  if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
...
@wolfs.on(itzjass(pattern=f"fry(?: |$)(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern="^!fry(?: |$)(.*)")
async def _(event):
  sender = await event.get_sender() ; me = await event.client.get_me()
  if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
...
@mrsammy(outgoing=True, pattern="^!ss2(?: |$)(.*)")
async def _(event):
  sender = await event.get_sender() ; me = await event.client.get_me()
  if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
...
@wolfs.on(itzjass(pattern=f"ss3(?: |$)(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern="^!ss3(?: |$)(.*)")
async def _(event):
  sender = await event.get_sender() ; me = await event.client.get_me()
  if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
...
@wolfs.on(itzjass(pattern=f"ss4(?: |$)(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern="^!ss4(?: |$)(.*)")
async def _(event):
  sender = await event.get_sender() ; me = await event.client.get_me()
  if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
...
@wolfs.on(itzjass(pattern=f"mask(?: |$)(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern="^!mask(?: |$)(.*)")
async def _(event):
  sender = await event.get_sender() ; me = await event.client.get_me()
  if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
...
@wolfs.on(itzjass(pattern=f"ushort(?: |$)(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern="^!ushort(?: |$)(.*)")
async def _(event):
  sender = await event.get_sender() ; me = await event.client.get_me()
  if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
...
@wolfs.on(itzjass(pattern=f"ss(?: |$)(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern="^!ss(?: |$)(.*)")
async def _(event):
  sender = await event.get_sender() ; me = await event.client.get_me()
  if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
