...
@wolfs.on(itzjass(pattern=f"(?:rspam|rsp)\s(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern=r"^\!(?:rspam|rsp)\s(.*)")
async def repeat(e):
...
@wolfs.on(itzjass(pattern=f"(?:cspam|csp)\s(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern=r"^\!(?:cspam|csp)\s(.*)")
async def tmeme(e):
  sender = await e.get_sender() ; me = await e.client.get_me()
  if not sender.id == me.id and not FULL_SUDO:
       return await e.reply("`Sorry normal sudo users cant access this command..`")
...
@wolfs.on(itzjass(pattern=f"(?:wspam|wsp)\s(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern=r"^\!(?:wspam|wsp)\s(.*)")
async def tmeme(e):
  sender = await e.get_sender() ; me = await e.client.get_me()
  if not sender.id == me.id and not FULL_SUDO:
       return await e.reply("`Sorry normal sudo users cant access this command..`")
...
@wolfs.on(itzjass(pattern=f"(?:spam|sp)\s(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern=r"^\!(?:spam|sp)\s(.*)")
async def spammer(e):
  sender = await e.get_sender() ; me = await e.client.get_me()
  if not sender.id == me.id and not FULL_SUDO:
       return await e.reply("`Sorry normal sudo users cant access this command..`")
...
@wolfs.on(itzjass(pattern=f"(?:mspam|msp)\s(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern=r"^\!(?:mspam|msp)\s(.*)")
...
@wolfs.on(itzjass(pattern=f"(?:dmspam|dmsp)\s(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern=r"^\!(?:dmspam|dmsp)\s(.*)")
async def tiny_pic_spam(e):
  sender = await e.get_sender() ; me = await e.client.get_me()
  if not sender.id == me.id and not FULL_SUDO:
       return await e.reply("`Sorry normal sudo users cant access this command..`")
...
@wolfs.on(itzjass(pattern=f"(?:delayspam|dsp)\s(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern=r"^\!(?:delayspam|dsp)\s(.*)")
async def spammer(e):
  sender = await e.get_sender() ; me = await e.client.get_me()
  if not sender.id == me.id and not FULL_SUDO:
       return await e.reply("`Sorry normal sudo users cant access this command..`")
