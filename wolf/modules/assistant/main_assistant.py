...
from wolf.modules.sql_helper.blacklist_assistant import (
    add_nibba_in_db,
    is_he_added,
    removenibba,
)
from wolf.modules.sql_helper.botusers_sql import add_me_in_db, his_userid
from wolf.modules.sql_helper.idadder_sql import (
    add_usersid_in_db,
    already_added,
    get_all_users,
)
    ...
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_message(
            ...
            buttons=[
                ...
                [Button.url("Help Me ❓", "https://t.me/WolfBotHelp")],
            ],
        )
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                ...
                [Button.url("Need Help ❓", "https://t.me/WolfBotHelp")],
            ],
        )
