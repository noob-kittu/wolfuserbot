...
@mrsammy(outgoing=True, pattern="^!warn(?: |$)(.*)")
async def _(event):
    if event.fwd_from:
        return
    try:
...
@mrsammy(outgoing=True, pattern="^!warns(?: |$)(.*)")
async def _(event):
    if event.fwd_from:
        return
    reply_message = await event.get_reply_message()
...
@wolfs.on(itzjass(pattern=f"warns(?: |$)(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    reply_message = await event.get_reply_message()
...
@mrsammy(outgoing=True, pattern="^!setwarnmode(?: |$)(.*)")
...
@wolfs.on(itzjass(pattern=f"setwarnmode(?: |$)(.*)", allow_sudo=True))
async def set_warn_strength(event):
    try:
      chat = await event.get_chat()
      admin = chat.admin_rights
...
@mrsammy(outgoing=True, pattern="^!setwarnlimit(?: |$)(.*)")
...
@wolfs.on(itzjass(pattern=f"setwarnlimit(?: |$)(.*)", allow_sudo=True))
async def set_warn_limit(event):
    try:
     chat = await event.get_chat()
     admin = chat.admin_rights
...
@mrsammy(outgoing=True, pattern="^!resetwarns(?: |$)(.*)")
async def _(event):
    if event.fwd_from:
        return
    reply_message = await event.get_reply_message()
