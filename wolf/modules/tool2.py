...
from wolf import (TEMP_DOWNLOAD_DIRECTORY, BOTLOG_CHATID, CMD_HELP, bot, client)
...
from wolf.events import humanbytes, progress, time_formatter
wolfs = client
...
@wolfs.on(itzjass(pattern=f"figlet(?: |$)(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern="^\!figlet(?: |$)(.*)")
async def figlet(e):
...
@wolfs.on(itzjass(pattern=f"docpic(?: |$)(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern="^\!docpic(?: |$)(.*)")
...
@wolfs.on(itzjass(pattern=f"ifsc(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern="^!ifsc(.*)")
async def _(event):
...
@wolfs.on(itzjass(pattern=f"zip$", allow_sudo=True))
@mrsammy(outgoing=True, pattern="^!zip$")
async def _(event):
    sender = await event.get_sender() ; me = await event.client.get_me()
    if not sender.id == me.id:
        rkp = await event.reply("`processing`")
...
@wolfs.on(itzjass(pattern=f"unzip$", allow_sudo=True))
@mrsammy(outgoing=True, pattern="^!unzip$")
async def _(event):
    sender = await event.get_sender() ; me = await event.client.get_me()
    if not sender.id == me.id:
        rkp = await event.reply("`processing`")
...
@wolfs.on(itzjass(pattern=f"dns (.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern=r"^!dns (.*)")
async def _(event):
    sender = await event.get_sender() ; me = await event.client.get_me()
    if not sender.id == me.id:
        rkp = await event.reply("`processing`")
...
@wolfs.on(itzjass(pattern=f"urlshort (.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern=r"^!urlshort (.*)")
async def _(event):
    sender = await event.get_sender() ; me = await event.client.get_me()
    if not sender.id == me.id:
        rkp = await event.reply("`processing`")
...
@wolfs.on(itzjass(pattern=f"urldirect (.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern=r"^!urldirect (.*)")
async def _(event):
    sender = await event.get_sender() ; me = await event.client.get_me()
    if not sender.id == me.id:
        rkp = await event.reply("`processing`")
...
@wolfs.on(itzjass(pattern=f"git (.*)", allow_sudo=True))
@mrsammy(pattern=r"!git (.*)", outgoing=True)
...
@wolfs.on(itzjass(pattern=f"create (b|g|c)(?: |$)(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern="^!create (b|g|c)(?: |$)(.*)")
...
@wolfs.on(itzjass(pattern=f"poll(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern="^!poll(.*)")
async def _(event):
    sender = await event.get_sender() ; me = await event.client.get_me()
    if not sender.id == me.id:
        rkp = await event.reply("`processing`")
...
@wolfs.on(itzjass(pattern=f"goss(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern="^!goss(.*)")
async def _(event):
    sender = await event.get_sender() ; me = await event.client.get_me()
    if not sender.id == me.id:
        rkp = await event.reply("`processing`")
