...
from wolf import CMD_HELP
from wolf.events import mrsammy
from wolf.modules.group import get_user_from_event
from telethon import events
import asyncio
from datetime import datetime
import requests
...
RUNS_STR = [
    ...
    "Running faster than Bolt coz i'mma wolf !!",
    "Runs to Marie..",
...
@mrsammy(pattern="^!slap(?: |$)(.*)", outgoing=True)
async def who(event):
...
@wolfs.on(itzjass(pattern=f"slap(?: |$)(.*)", allow_sudo=True))
async def who(event):
    """ slaps a user, or get slapped if not a reply. """
    replied_user = await get_user_from_event(event)
    if replied_user:
...
@mrsammy(outgoing=True, pattern="^-_-$")
async def lol(lel):
    """ Ok... """
    okay = "-_-"
    for i in range(10):
...
@mrsammy(outgoing=True, pattern="^!(yes|no|maybe|decide)$")
...
@mrsammy(outgoing=True, pattern="^!fp$")
async def facepalm(e):
    """ Facepalm  🤦‍♂ """
    await e.edit("🤦‍♂")


@mrsammy(outgoing=True, pattern="^!cry$")
async def cry(e):
    """ y u du dis, i cry everytime !! """
    await e.edit(choice(CRI))


@mrsammy(outgoing=True, pattern="^!abuse$")
async def insult(e):
    """ I make you cry !! """
    await e.edit(choice(INSULT_STRINGS))


@wolfs.on(itzjass(pattern=f"abuse$", allow_sudo=True))
async def insult(e):
    """ I make you cry !! """
    await e.reply(choice(INSULT_STRINGS))


@mrsammy(outgoing=True, pattern="^!cp(?: |$)(.*)")
...
@mrsammy(outgoing=True, pattern="^!vapor(?: |$)(.*)")
async def vapor(vpr):
    """ Vaporize everything! """
    reply_text = list()
...
@mrsammy(outgoing=True, pattern="^!str(?: |$)(.*)")
...
@mrsammy(outgoing=True, pattern="^!style(?: |$)(.*)")
async def zal(zgfy):
...
@wolfs.on(itzjass(pattern=f"style(?: |$)(.*)", allow_sudo=True))
async def zal(zgfy):
    """ Invoke the feeling of chaos. """
    if not zgfy.text[0].isalpha() and zgfy.text[0] not in ("/", "#", "@", "!"):
        reply_text = list()
...
@mrsammy(outgoing=True, pattern="^!hi$")
async def hoi(hello):
    """ Greet everyone! """
    await hello.edit(choice(HELLOSTR))


@mrsammy(outgoing=True, pattern="^!owo(?: |$)(.*)")
async def faces(owo):
    """ UwU """
...
@mrsammy(outgoing=True, pattern="^!react$")
async def react_meme(react):
    """ Make your wolf react to everything. """
    await react.edit(choice(FACEREACTS))


@mrsammy(outgoing=True, pattern="^!iwi(?: |$)(.*)")
...
@mrsammy(outgoing=True, pattern="^!shg$")
...
@mrsammy(outgoing=True, pattern="^Oof$")
async def Oof(e):
    t = "Oof"
    for j in range(15):
        t = t[:-1] + "of"
...
@mrsammy(outgoing=True, pattern="^!kill$")
async def iqless(e):
...
@mrsammy(outgoing=True, pattern="^!bye$")
async def iqless(e):
    await e.edit("Kek thx bye")       
                      

@mrsammy(outgoing=True, pattern="^!moon$")
...
@mrsammy(outgoing=True, pattern="^!earth$")
...
@mrsammy(outgoing=True, pattern="^!clock$")
...
@mrsammy(outgoing=True, pattern="^!rain$")
...
@mrsammy(outgoing=True, pattern="^!love$")
...
@mrsammy(outgoing=True, pattern="^!mock(?: |$)(.*)")
...
@mrsammy(outgoing=True, pattern="^!clap(?: |$)(.*)")
...
@mrsammy(outgoing=True, pattern="^!bt$")
...
@mrsammy(outgoing=True, pattern=r"^!f (.*)")
...
@mrsammy(pattern=r"!type(?: |$)(.*)", outgoing=True)
...
@mrsammy(outgoing=True, pattern="^.fail$")
async def fail(e):
...
@mrsammy(outgoing=True, pattern="^.lol$")
async def lol(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n╱┏┓╱╱╱╭━━━╮┏┓╱╱╱╱ `" 
                     "`\n╱┃┃╱╱╱┃╭━╮┃┃┃╱╱╱╱ `"       
...
@mrsammy(outgoing=True, pattern="^.amaan$")
async def amaan(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n╱╭━━━╮               `"
                     "`\n╱┃╭━╮┃               `"
...
@mrsammy(outgoing=True, pattern="^.lool$")
async def lool(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n╭╭━━━╮╮┈┈┈┈┈┈┈┈┈┈\n┈┃╭━━╯┈┈┈┈▕╲▂▂╱▏┈\n┈┃┃╱▔▔▔▔▔▔▔▏╱▋▋╮┈`"
                     "`\n┈┃╰▏┃╱╭╮┃╱╱▏╱╱▆┃┈\n┈╰━▏┗━╰╯┗━╱╱╱╰┻┫┈\n┈┈┈▏┏┳━━━━▏┏┳━━╯┈`"
...
@mrsammy(outgoing=True, pattern="^.nih$")
async def nih(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n(\_/)`"
                     "`\n(•_•)`"
...
@mrsammy(outgoing=True, pattern="^.hello$")  
async def gtfo(e):
   if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n█████████`" 
                     "`\n█▄█████▄█`"    
...
@mrsammy(outgoing=True, pattern="^.ml(?: |$)(.*)")
async def gtfo(e):
...
@mrsammy(outgoing=True, pattern="^.taco$")  
async def taco(e):
   if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("\n{\__/}"
                     "\n(●_●)"
...
@mrsammy(outgoing=True, pattern="^.paw$")  
async def paw(e):
   if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`(=ↀωↀ=)")


@mrsammy(outgoing=True, pattern="^.tf$")  
async def tf(e):
   if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("(̿▀̿ ̿Ĺ̯̿̿▀̿ ̿)̄  ")  
       
                  
@mrsammy(outgoing=True, pattern="^.gey$")            
async def gey(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n┈┈┈╭━━━━━╮┈┈┈┈┈\n┈┈┈┃┊┊┊┊┊┃┈┈┈┈┈`"
                     "`\n┈┈┈┃┊┊╭━╮┻╮┈┈┈┈\n┈┈┈╱╲┊┃▋┃▋┃┈┈┈┈\n┈┈╭┻┊┊╰━┻━╮┈┈┈┈`"
...
@mrsammy(outgoing=True, pattern="^.gay$")            
async def gey(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n┈┈┈╭━━━━━╮┈┈┈┈┈\n┈┈┈┃┊┊┊┊┊┃┈┈┈┈┈`"
                     "`\n┈┈┈┃┊┊╭━╮┻╮┈┈┈┈\n┈┈┈╱╲┊┃▋┃▋┃┈┈┈┈\n┈┈╭┻┊┊╰━┻━╮┈┈┈┈`"
...
@mrsammy(outgoing=True, pattern="^.bot$")
async def bot(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("` \n   ╲╲╭━━━━╮ \n╭╮┃▆┈┈▆┃╭╮ \n┃╰┫▽▽▽┣╯┃ \n╰━┫△△△┣━╯`"
                     "`\n╲╲┃┈┈┈┈┃  \n╲╲┃┈┏┓┈┃ `")
...
@mrsammy(outgoing=True, pattern="^.hey$")
async def hey(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("\n┈┈┈╱▔▔▔▔╲┈╭━━━━━\n┈┈▕▂▂▂▂▂▂▏┃HEY!┊😀`"
                     "`\n┈┈▕▔▇▔▔┳▔▏╰┳╮HEY!┊\n┈┈▕╭━╰╯━╮▏━╯╰━━━\n╱▔▔▏▅▅▅▅▕▔▔╲┈┈┈┈`"
...
@mrsammy(outgoing=True, pattern="^.nou$")
async def nou(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n┈╭╮╭╮\n┈┃┃┃┃\n╭┻┗┻┗╮`"
                     "`\n┃┈▋┈▋┃\n┃┈╭▋━╮━╮\n┃┈┈╭╰╯╰╯╮`"
...
@mrsammy(outgoing=True, pattern="^.mf$")  
async def gtfo(e):
   if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
"\n......................................../´¯/) "
...
@mrsammy(outgoing=True, pattern="^!sayhi$")
async def shalom(e):
    await e.edit(
        "\n💛💛💛💛💛💛💛💛💛"
        "\n💛🔷🔷🔷🔷🔷🔷🔷💛"
...
@mrsammy(outgoing=True, pattern="^!call(?: |$)(.*)")
...
async def _(event):
   ...
   # if input_str == "call":
    ...
    animation_chars = [
            ...
            "`Me: Yo this is` @mrsammy ,`Please Connect me to my lil bro,lel`",
            "`User Authorised.`",
            "`Calling lel Durov`  `At +94776996xxx`",
            "`Private  Call Connected...`",
            "`Me: Hello Sir, Please Ban This Telegram Account.`",    
            "`lel: May I Know Who Is This?`",
            f"`Me: Yo Brah, I Am` {WOLF_NNAME} ",
...
@mrsammy(outgoing=True, pattern="^!logic(?: |$)(.*)")
...
@mrsammy(outgoing=True, disable_errors=True, pattern="^!fry2(?: |$)(.*)")
...
@mrsammy(outgoing=True, pattern="^!instant(?: |$)(.*)")
async def _(event):
    if event.fwd_from:
        return 
    if not event.reply_to_msg_id:
...
@mrsammy(outgoing=True, pattern="^!play$")
...
@mrsammy(outgoing=True, pattern="^!ding$")
...
@mrsammy(outgoing=True, pattern="^!leave$")
async def leave(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`You must Leaving dis Group kek!`")


@mrsammy(outgoing=True, disable_errors=True, pattern="^!wtf$")
async def _(event):
...
@mrsammy(outgoing=True, disable_errors=True, pattern="^!whack$")
async def _(event):
...
@mrsammy(outgoing=True, disable_errors=True, pattern="^!snake$")
async def _(event):
...
@mrsammy(outgoing=True, disable_errors=True, pattern="^!soler$")
async def _(event):
...
@mrsammy(outgoing=True, disable_errors=True, pattern="^!think$")
async def _(event):
...
@mrsammy(outgoing=True, disable_errors=True, pattern="^!hack$")
async def _(event):
...
@mrsammy(outgoing=True, disable_errors=True, pattern="^!bomb(?: |$)(.*)")
async def _(event):
    if event.fwd_from:
        return
...
@mrsammy(outgoing=True, disable_errors=True, pattern="^!sad(?: |$)(.*)")
...
@mrsammy(outgoing=True, disable_errors=True, pattern="^!play1$")
async def _(event):
...
@mrsammy(outgoing=True, disable_errors=True, pattern="^!play2$")
async def _(event):
...
@mrsammy(outgoing=True, disable_errors=True, pattern="^!play3$")
async def _(event):
...
@mrsammy(outgoing=True, pattern="^!moon2$")
async def test(event):
    if event.fwd_from:
        return 
    await event.edit("🌕🌕🌕🌕🌕🌕🌕🌕\n🌕🌕🌖🌔🌖🌔🌕🌕\n🌕🌕🌗🌔🌖🌓🌕🌕\n🌕🌕🌗🌔🌖🌓🌕🌕\n🌕🌕🌖🌓🌗🌔🌕🌕\n🌕🌕🌗🌑🌑🌓🌕🌕\n🌕??🌗👀🌑🌓🌕🌕\n🌕??🌘👄🌑🌓🌕🌕\n🌕🌕🌗????🌒🌕🌕\n🌕🌖🌑🌑🌑🌑🌔🌕\n🌕🌘🌑🌑🌑🌑🌒🌕\n🌖🌑🌑🌑🌑🌑🌑🌔\n🌕🤜🏻🌑🌑🌑🌑🤛🏻🌕\n🌕🌖🌑🌑🌑🌑🌔🌕\n🌘🌑🌑🌑🌑🌑🌑🌒\n🌕🌕🌕🌕🌕🌕🌕🌕")

@mrsammy(outgoing=True, pattern="^!city$")
async def test(event):
    if event.fwd_from:
        return 
    await event.edit("""☁☁🌞      ☁           ☁
...
@mrsammy(outgoing=True, pattern="^!cheer$")
async def cheer(event):
    if event.fwd_from:
        return
    await event.edit("💐💐😉😊💐💐\n☕ Cheer Up  🍵\n🍂 ✨ )) ✨  🍂\n🍂┃ (( * ┣┓ 🍂\n🍂┃*💗 ┣┛ 🍂 \n🍂┗━━┛  🍂🎂 For YOU  🍰\n💐💐😌😚💐💐")

@mrsammy(outgoing=True, pattern="^!getwell$")
async def getwell(event):
    if event.fwd_from:
        return
    await event.edit("🌹🌹🌹🌹🌹🌹🌹🌹 \n🌹😷😢😓😷😢💨🌹\n🌹💝💉🍵💊💐💝🌹\n🌹 GetBetter Soon! 🌹\n🌹🌹🌹🌹🌹🌹🌹🌹")

@mrsammy(outgoing=True, pattern="^!luck$")
async def luck(event):
    if event.fwd_from:
        return
    await event.edit("💚~🍀🍀🍀🍀🍀\n🍀╔╗╔╗╔╗╦╗✨🍀\n🍀║╦║║║║║║👍🍀\n🍀╚╝╚╝╚╝╩╝。 🍀\n🍀・・ⓁⓊⒸⓀ🍀\n🍀🍀🍀 to you💚")

@mrsammy(outgoing=True, pattern="^!love2$")
...
@mrsammy(outgoing=True, disable_errors=True, pattern="^!nakal$")
...
@mrsammy(outgoing=True, pattern="^!police$")
...
@mrsammy(outgoing=True, pattern=r"^\!(?:penis|dick)\s?(.)?")
...
@mrsammy(outgoing=True, pattern="^!noob$")
async def insult(e):
    """ I make you cry !! """
    await e.edit(choice(NOOBSTR))


@mrsammy(outgoing=True, pattern="^!abuse2$")
async def insult(e):
    """ I make you cry !! """
...
@mrsammy(outgoing=True, pattern="^!abuse3$")
...
@mrsammy(outgoing=True, pattern="^!fuck$")
...
@mrsammy(outgoing=True, pattern="^!sax$")
...
@mrsammy(outgoing=True, pattern="^!dump ?(.*)")
async def _(message):
    try:
