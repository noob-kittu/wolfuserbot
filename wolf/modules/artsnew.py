...
@wolfs.on(admin_cmd(pattern=r"monster"))
async def bluedevilmonster(monster):
    await monster.edit(M)
@wolfs.on(admin_cmd(pattern=r"pig"))
async def bluedevilpig(pig):
    await pig.edit(P)
@wolfs.on(admin_cmd(pattern=r"kiler"))
async def bluedevilkiller(kiler):
    await kiler.edit(K)
@wolfs.on(admin_cmd(pattern=r"gun"))
async def bluedevilgun(gun):
    await gun.edit(G)
@wolfs.on(admin_cmd(pattern=r"dog"))
async def bluedevildog(dog):
    await dog.edit(D)    
@wolfs.on(admin_cmd(pattern=r"hello"))
async def bluedevilhello(hello):
    await hello.edit(H)
@wolfs.on(admin_cmd(pattern=r"hmf"))
