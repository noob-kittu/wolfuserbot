...
from wolf.wolfbot.commands import progress, humanbytes, time_formatter, admin_cmd
from wolf import client, TEMP_DOWNLOAD_DIRECTORY, CMD_HELP, COUNTRY, TZ_NUMBER
thumb_image_path = TEMP_DOWNLOAD_DIRECTORY + "/thumb_image.jpg"
from wolf.events import mrsammy, itzjass, progress
wolfs = client
...
from wolf import client, BOTLOG_CHATID, CMD_HELP, BOTLOG, BOTLOG_CHATID, YOUTUBE_API_KEY, TEMP_DOWNLOAD_DIRECTORY, CHROME_DRIVER, GOOGLE_CHROME_BIN, bot
...
@mrsammy(outgoing=True, pattern="^!search (.*)")
@wolfs.on(itzjass(pattern=f"search (.*)", allow_sudo=True))
...
@wolfs.on(itzjass(pattern=f"stats(?: |$)(.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern=r"^!stats(?: |$)(.*)") 
...
@mrsammy(pattern="!inviteall(?: |$)(.*)", outgoing=True)
@wolfs.on(itzjass(pattern=f"inviteall(?: |$)(.*)", allow_sudo=True))
...
@mrsammy(pattern="!inviteall2(?: |$)(.*)", outgoing=True)
async def get_users(event):   
    rk1 = await get_chatinfo(event) ; chat = await event.get_chat()
    if event.is_private:
...
@mrsammy(outgoing=True, pattern="^!tagall$")
@wolfs.on(itzjass(pattern=f"tagall$", allow_sudo=True))
async def _(event):
    sender = await event.get_sender() ; me = await event.client.get_me()
    if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
...
@mrsammy(outgoing=True, pattern="^!crblang (.*)")
@wolfs.on(itzjass(pattern=f"crblang (.*)", allow_sudo=True))
...
@mrsammy(outgoing=True, pattern=r"^!tts2(?: |$)([\s\S]*)")
@wolfs.on(itzjass(pattern=f"tts2(?: |$)([\s\S]*)", allow_sudo=True))
...
@mrsammy(outgoing=True, pattern=r"^!trt(?: |$)([\s\S]*)")
@wolfs.on(itzjass(pattern=f"trt(?: |$)([\s\S]*)", allow_sudo=True))
...
@mrsammy(pattern="!lang (trt|tts) (.*)", outgoing=True)
@wolfs.on(itzjass(pattern=f"lang (trt|tts) (.*)", allow_sudo=True))
...
@mrsammy(outgoing=True, pattern=r"!get (audio|video) (.*)")
@wolfs.on(itzjass(pattern=f"get (audio|video) (.*)", allow_sudo=True))
...
@mrsammy(outgoing=True, pattern=r"^\!tts(?: |$)([\s\S]*)")
@wolfs.on(itzjass(pattern=f"tts(?: |$)([\s\S]*)", allow_sudo=True))
async def _(event):
    sender = await event.get_sender() ; me = await event.client.get_me()
    if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
...
@mrsammy(outgoing=True, pattern="^!time(?: |$)(.*)(?<![0-9])(?: |$)([0-9]+)?")
@wolfs.on(itzjass(pattern=f"time(?: |$)(.*)(?<![0-9])(?: |$)([0-9]+)?", allow_sudo=True))
...
@mrsammy(outgoing=True, pattern="^!date(?: |$)(.*)(?<![0-9])(?: |$)([0-9]+)?")
@wolfs.on(itzjass(pattern=f"date(?: |$)(.*)(?<![0-9])(?: |$)([0-9]+)?", allow_sudo=True))
...
@mrsammy(outgoing=True, pattern="^!carbon ?(.*)")
@wolfs.on(itzjass(pattern=f"carbon ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    sender = await event.get_sender() ; me = await event.client.get_me()
...
@wolfs.on(itzjass(pattern=f"song (.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern=r"!song (.*)")
async def download_video(v_url):  
...
@wolfs.on(itzjass(pattern=f"vsong (.*)", allow_sudo=True))
@mrsammy(outgoing=True, pattern=r"!vsong (.*)")
async def download_video(v_url):  
    lazy = v_url ; sender = await lazy.get_sender() ; me = await lazy.client.get_me()
    if not sender.id == me.id:
        rkp = await lazy.reply("`processing...`")
