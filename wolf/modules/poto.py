...
from wolf.utils import admin_cmd as friday_on_cmd
...
if 1 == 1:
    ...
    @wolfs.on(friday_on_cmd(pattern="poto(.*)"))
    ...
    async def potocmd(event):
        ...
        if id.strip() == "":
            ...
            try:
                ...
                await wolfs.send_file(event.chat_id, photo)
            ...
            if int(id) <= (len(photos)):
                ...
                await wolfs.send_file(event.chat_id, send_photos)
