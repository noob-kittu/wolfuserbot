  ...
  if event.is_private: 
   if EP : 
       ...
       return await event.reply(
                     f"`{WOLF_NNAME}:` **User  Edited His message !!** \n"                      
                     f"**date**: `{date}`\n"                   
    	...
    	if LG:   
           ...
           if admin or creator:
                ...
                return await rkG.reply(
                     f"`{WOLF_NNAME}:` ** User left the group and permanently banned!!** \n"                      
...
\n**Usage:**  Off DG \
\n\n!set var LG True\
\n**Usage:**  If any one leave your group wolfs auto ban him permanently \
\n\n!del var LG \
\n**Usage:**  Off LG \
